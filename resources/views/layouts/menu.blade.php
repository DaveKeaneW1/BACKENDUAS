     ...
     <div class="main_menu">
         <nav class="navbar navbar-expand-lg navbar-light main_box">
             <div class="container">
                 ...
                 <a class="navbar-brand logo_h" href="index.html"><img src="/img/logo-sgu.png" alt=""
                 ...
                 @if (request()->is('admin*'))
                     ...
                     <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                         <ul class="nav navbar-nav menu_nav ml-auto">
                             <li class="nav-item {{ request()->is('admin') ? 'active' : '' }}"><a class="nav-link"
                             ...
                             <li class="nav-item {{ request()->is('admin/admin*') ? 'active' : '' }}"><a
                                     class="nav-link" href="{{ route('admin.product') }}">Admin</a></li>
                             <li class="nav-item {{ request()->is('admin/customer*') ? 'active' : '' }}"><a
                                     class="nav-link" href="{{ route('admin.product') }}">Customer</a></li>
                             <li class="nav-item {{ request()->is('admin/order*') ? 'active' : '' }}"><a
                                     class="nav-link" href="{{ route('admin.product') }}">Orders</a></li>
                             <li class="nav-item {{ request()->is('/admin/logout') ? 'active' : '' }}"><a
                 ...
                 @else
                     ...
                     <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                         <ul class="nav navbar-nav menu_nav ml-auto">
                             ...
                             <li class="nav-item {{ request()->is('/admin/login') ? 'active' : '' }}"><a
                             ...
                             <li class="nav-item" {{ request()->is('/registration') ? 'active' : '' }}><a
                                     class="nav-link" href="{{ route('authentication.registration') }}">Registration</a></li>
                         </ul>
